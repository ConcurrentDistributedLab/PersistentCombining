...
/// @brief This function returns whenever all the created posix threads and fibers spawned by synchStartThreadsN
/// have completed the execution. 
/// @param nthreads The number of posix threads minus 1 that synchStartThreadsN spawned.
